...
if(isset($_POST['title'])){
    ...
    move_uploaded_file($imgtmp,"../assets/img/".$imgname);

    addblog($title,$description,$imgname,$category,$user_id);
            ...
            <form action="addblog.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="file" name="img" class="form-control" id="exampleInputEmail1" placeholder="Enter title">
                  </div>
                </div>
