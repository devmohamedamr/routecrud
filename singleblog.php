...
if(!empty($_GET['id'])){
  ...
  $id = $_GET['id'];
  $blog_details =   selectblogbyid($id);

  $reviews =  getreviewbyblogid($id);
      ...
      <div class="container text-center">
        ...
        <div class="row h-full">
          <div class="col-12 col-lg-8 offset-lg-2 align-self-center">
            ...
            <br>
            <h1 class="display-4 hidden-sm-down"><?= $blog_details['title']; ?></h1>
          ...
          <div class="row">
            <div class="col-12 col-lg-8 offset-lg-2">
               ...
               <?php if(!empty($reviews)): ?> 
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p class="fs-13"><?= $reivew['comment']; ?></p>
                  </div>
                </div>
                <?php endforeach; ?>
                <?php endif; ?>
              ...
              <!-- <form action="#" method="POST"> -->
                ...
                <input class="form-control" id="blog_id" value="<?=$_GET['id']?>"  type="hidden" placeholder="Email">
                ...
                <button onclick="save()" class="btn btn-primary btn-block" type="submit">Submit your comment</button>
              <!-- </form> -->
    ...
    <script>
        function save(){
          ...
          $.ajax({
            type:'POST',
            url:'comment.php',
            data:{name:name,email:email,review:review,blog_id:blog_id},
            success : function(){
